 ...
 * Purpose: 2. Write a program CarLoan.java that reads in three command-line arguments P, Y,
 * and R and calculates the monthly payments you would have to make over Y years to
 * pay off a P principal loan amount at R per cent interest compounded monthly. The
 * formula is The formula is..
 */
